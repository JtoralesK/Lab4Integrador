			...
			<div class="grid grid-cols-2 gap-4">
				<div>
					<label for="dni">DNI:</label> <input type="text" id="dni"
						name="dni" class="w-full p-2 rounded" required>
				</div>
				<div>
					<label for="cuil">CUIL:</label> <input type="text" id="cuil"
						name="cuil" class="w-full p-2 rounded" required>
				</div>
				<div>
					<label for="nombre">Nombre:</label> <input type="text" id="nombre"
						name="nombre" class="w-full p-2 rounded" required>
				</div>
				<div>
					<label for="apellido">Apellido:</label> <input type="text"
						id="apellido" name="apellido" class="w-full p-2 rounded" required>
				</div>
				<div>
				...
				<div>
					<label for="nacionalidad">Nacionalidad:</label> <input type="text"
						id="nacionalidad" name="nacionalidad" class="w-full p-2 rounded" required>
				</div>
				<div>
				...
				<div>
					<label for="localidad">Localidad:</label> <input type="text"
						id="localidad" name="localidad" class="w-full p-2 rounded" required>
				</div>
				<div>
					<label for="provincia">Provincia:</label> <input type="text"
						id="provincia" name="provincia" class="w-full p-2 rounded" required>
				</div>
				<div>
					<label for="email">Correo Electrónico:</label> <input type="email"
						id="email" name="email" class="w-full p-2 rounded" required>
				</div>
				<div>
					<label for="telefonos">Teléfonos:</label> <input type="text"
						id="telefonos" name="telefonos" class="w-full p-2 rounded" required>
				</div>
				<div>
					<label for="usuario">Usuario:</label> <input type="text"
						id="usuario" name="usuario" class="w-full p-2 rounded" required>
				</div>
				<div>
					<label for="password">Contraseña:</label> <input type="password"
						id="password" name="password" class="w-full p-2 rounded" required>
				</div>
			</div>
			<div class="flex">
				<button type="submit"
					class="bg-blue-500 text-white p-3 mt-5 rounded hover:bg-blue-700 ml-auto">Crear
					Usuario</button>
			</div>
		</form>
	</div>
